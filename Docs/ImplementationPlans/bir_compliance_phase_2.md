...
- **Immutability Check**:
    - In [updateStore](file:///e:/2026/Pos/backend/src/controllers/storeController.ts#21-63), verify if `orders` exist for the store.
...
- **Tax Breakdown**:
    - Update [createOrder](file:///e:/2026/Pos/backend/src/controllers/orderController.ts#18-137) to accept and store the detailed tax fields provided by the frontend.
